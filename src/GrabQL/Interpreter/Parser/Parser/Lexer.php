<?php
/**
 * This class defines the parser lexer of GrabQL Interpreter.
 *
 * @package     GrabQL
 ...
 *
 * Based on Doctrine Lexer and the tutorial of Jonathan H. Wage at the URL
 * http://jwage.com/post/31623163785/writing-a-parser-in-php-with-the-help-of-doctrine
 *
 */
namespace GrabQL\Interpreter\Parser\Parser;
...
class Lexer extends AbstractLexer
{
    ...
    */
    ...
    /**
     * Create a new query scanner object.
     *
    ...
    protected function getType(&$value)
    {
        ...
        if ($value[0] === "'") {
            ...
            $name = 'GrabQL\Interpreter\Parser\Parser\Lexer::T_' . strtoupper($value);
